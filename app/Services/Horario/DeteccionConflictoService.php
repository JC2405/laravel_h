...
class DeteccionConflictoService
{
    ...
    // =========================================================================
    //  HELPER: detectar los dos conflictos a la vez
    // =========================================================================

    /**
     * Ejecuta ambas detecciones en una sola llamada.
     *
     * Útil cuando se quiere revisar instructor Y ambiente al mismo tiempo
     * sin hacer dos llamadas separadas.
     *
     * @return array ['instructor' => object|null, 'ambiente' => object|null]
     */
    public function detectarAmbosConflictos(
        int     $idInstructor,
        int     $idAmbiente,
        string  $horaInicio,
        string  $horaFin,
        ...
        return [
            'instructor' => $this->detectarConflictoInstructor(
                $idInstructor, $horaInicio, $horaFin,
                $diasDeLaSemana, $fechaInicio, $fechaFin,
                $excluirBloque, $excluirFicha
            ),
            'ambiente' => $this->detectarConflictoAmbiente(
                $idAmbiente, $horaInicio, $horaFin,
                $diasDeLaSemana, $fechaInicio, $fechaFin,
                $excluirBloque, $excluirFicha
            ),
        ];
