        ...
        <div>
            ...
            @php
                ...
                foreach ($horario['asignaciones'] ?? [] as $asig) {
                    $fi = $asig->bloque->fechaInicio ?? $asig['bloque']['fechaInicio'] ?? $asig->fechaInicio ?? $asig['fechaInicio'] ?? null;
                    $ff = $asig->bloque->fechaFin ?? $asig['bloque']['fechaFin'] ?? $asig->fechaFin ?? $asig['fechaFin'] ?? null;
